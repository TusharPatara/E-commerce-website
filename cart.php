...
while ($row = mysqli_fetch_array($result)) {
    ...
    $id = rtrim($id, ", ");
    echo "<tr><td></td><td>Total</td><td>Rs " . $sum . "</td><td><a href='payment.php' class='btn btn-primary'>Confirm Order</a></td></tr>";
    ?>
                            </tbody>
                            <?php
} else {
    echo "<div> <img src='images/emptycart.png' class='image-fluid mx-auto d-block' height='190' width='330'></div><br/>";
    echo "<div class='text-bold text-center  h5'>Add items to the cart first!<div>";
